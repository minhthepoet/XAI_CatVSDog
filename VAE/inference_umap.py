...
def get_args():
    parser = argparse.ArgumentParser(description="UMAP visualization for Vanilla VAE latent space.")
...
def main():
    ...
    out_png = args.out_png or str(exp_root / "logs" / "latent_umap_vanilla.png")
    out_npz = args.out_npz or str(exp_root / "logs" / "latent_umap_vanilla.npz")
    ...
    plt.title(f"Vanilla VAE Latent UMAP by {args.label_by} (N={z.shape[0]})")
