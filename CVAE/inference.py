...
if __package__ is None or __package__ == "":
    ...
    from VAE.data_preprocessing import PairedActsDataset, build_image_transform
...
def get_args():
    parser = argparse.ArgumentParser(description="t-SNE visualization for CVAE latent space.")
...
def main():
    ...
    out_png = args.out_png or str(exp_root / "logs" / "latent_tsne.png")
    out_npz = args.out_npz or str(exp_root / "logs" / "latent_tsne.npz")
    ...
    plt.title(f"CVAE Latent Space t-SNE by {args.label_by} (N={z.shape[0]})")
